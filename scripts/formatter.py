...
- 主标题：居中，小二号（18pt），方正小标宋简体
- 主送机关：顶格，三号仿宋
- 正文：三号仿宋GB2312，首行缩进2字符，固定行距30磅
- 一级标题："一、" 三号方正黑体_GBK，首行缩进2字符
...
PRESETS = {
    'official': {
        ...
        'page': {'top': 2.54, 'bottom': 2.54, 'left': 3.18, 'right': 3.18},
        # 主标题：小二号方正小标宋简体，居中
        'title': {
            'font_cn': '方正小标宋简体',
        ...
        # 正文：三号仿宋GB2312，首行缩进2字符（32pt），固定行距30磅
        'body': {
            'font_cn': '仿宋_GB2312',
            'font_en': 'Times New Roman',
            'size': 16,
